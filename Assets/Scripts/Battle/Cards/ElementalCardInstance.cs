...
public class ElementalCardInstance : MonoBehaviour, IPointerClickHandler
{
    ...
    {
        if (!BattleManager.Instance.PlayerInputEnabled)
            return;
        ...
        if (isSelected)
        {
            ...
            BattleManager.Instance.AddElementToCombo(elementType, this);
        }
        else
            BattleManager.Instance.RemoveElementFromCombo(elementType, this);
    }
    public void Consume()
    {
