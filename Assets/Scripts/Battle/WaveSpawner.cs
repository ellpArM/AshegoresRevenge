...
public class WaveSpawner : MonoBehaviour
{
    ...
    [SerializeField] public List<FightingEntity> enemies;
    ...
    private IEnumerator SpawnBoss()
    {
        ...
        FightingEntity entity = newCardGO.GetComponent<FightingEntity>();
        entity.ScalePower(healthScale, damageScale);
    ...
    {
        FightingEntity randomEnemy = enemies[Random.Range(0, enemies.Count)];
