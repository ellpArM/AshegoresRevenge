...
public class ElementalShieldPassive : PassiveSkill
{
    ...
    private FightingEntity ownerInstance;
    ...
    private void Start()
    {
        ownerInstance = GetComponent<FightingEntity>();
        if (ownerInstance)
        {
    ...
    public override void InitializeFromCaster(HeroEntity mainHero)
    {
    ...
    public override void OnReceiveDamage(ref int dmg, ElementType dmgType, FightingEntity owner)
    {
