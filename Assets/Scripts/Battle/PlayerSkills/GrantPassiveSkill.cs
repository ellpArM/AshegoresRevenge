...
public class GrantPassiveSkill : BaseSkill
{
    ...
    {
        yield return BattleManager.Instance.StartCoroutine(ApplyPassivesRoutine());
    }
    public override string UpdatedDescription()
    {
        HeroEntity hero = BattleManager.Instance.GetHeroOfelement(mainElement);
    ...
    private IEnumerator ApplyPassivesRoutine()
    {
        ...
        List<HeroEntity> heroes = BattleManager.Instance.PlayerHeroes;
        HeroEntity mainHero = BattleManager.Instance.GetHeroOfelement(mainElement);
    ...
    {
        var heroes = BattleManager.Instance.PlayerHeroes;
