...
public class MeteorSkill : BaseSkill
{
    ...
    {
        yield return BattleManager.Instance.StartCoroutine(WaitForTargetAndCastMeteor());
    }
    ...
    private IEnumerator WaitForTargetAndCastMeteor()
    {
        ...
        FightingEntity target = BattleManager.Instance.SelectedTarget;
    ...
    {
        List<FightingEntity> enemies = BattleManager.Instance.GetEnemies().ToList();
