...
public abstract class BaseSkill : MonoBehaviour
{
    ...
    {
        Dictionary<ElementType, HeroEntity> contributingHeroes = new Dictionary<ElementType, HeroEntity>();
        foreach (var hero in BattleManager.Instance.PlayerHeroes)
        {
        ...
        {
            HeroEntity hero = contributingHeroes[element];
            ...
            BattleManager.Instance.StartCoroutine(MoveProjectile(proj, riseTarget, launchDuration));
